...
with tab_archive:
    ...
    st.write('''[발표자료](https://github.com/podomin/menstruation_guide/blob/main/3%EC%A1%B0_%EC%98%AC%EB%A6%AC%EB%B8%8C%EC%98%81-%EB%A6%AC%EB%B7%B0-%EA%B0%90%EC%84%B1%EB%B6%84%EC%84%9D%20(2).pdf) ''', unsafe_allow_html=True)
